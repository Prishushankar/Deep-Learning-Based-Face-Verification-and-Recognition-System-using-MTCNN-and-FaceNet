...
try {
    ...
    Write-Host "⚠️ Git operation failed - you may need to push manually" -ForegroundColor Yellow
}
...
Write-Host "     - Python Version: 3.9.18 ⚠️ CRITICAL!" -ForegroundColor Red
...
Write-Host ""
Write-Host "🔹 Step 4: Monitor Build (10-15 min)" -ForegroundColor Blue
Write-Host "   ✅ Look for: 'Python version check passed: Python 3.9.x'" -ForegroundColor Green
Write-Host "   ❌ If you see Python 3.13: STOP and recreate service!" -ForegroundColor Red
Write-Host ""

Write-Host "⚠️ BUILD EXPECTATIONS" -ForegroundColor Yellow
Write-Host "=====================" -ForegroundColor Yellow
Write-Host ""
